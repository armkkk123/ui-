...
function Library:CreateWindow(config)
    ...
    local toggleIcon   = config.ToggleIcon or "rbxassetid://7734055395"
    ...
    Library:Create("UICorner", {CornerRadius = UDim.new(0, 6), Parent = MinBtn})
    ...
    MinBtn.MouseLeave:Connect(function()
        ...
        MinBtn.TextColor3 = Library.Theme.TextSub
    end)
    ...
    function Window:CreateTab(tabName, tabIcon)
        ...
        do
            ...
            function Tab:CreateButton(options)
                ...
                local btnStroke = Library:Create("UIStroke", {Color = Library.Theme.Stroke, Thickness = 1, Parent = btn})
