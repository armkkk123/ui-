...
local RayfieldLibrary = {
	Flags = {},
	Theme = {
		Default = { -- [🎨 ANTIGRAVITY NOIR THEME]
			TextColor = Color3.fromRGB(255, 255, 255),

			Background = Color3.fromRGB(44, 78, 122), -- Base ocean color
			Topbar = Color3.fromRGB(30, 50, 90),
			Shadow = Color3.fromRGB(0, 0, 0),

			NotificationBackground = Color3.fromRGB(14, 14, 20),
			NotificationActionsBackground = Color3.fromRGB(0, 210, 255),

			TabBackground = Color3.fromRGB(22, 22, 30),
			TabStroke = Color3.fromRGB(40, 40, 55),
			TabBackgroundSelected = Color3.fromRGB(0, 200, 255),
			TabTextColor = Color3.fromRGB(180, 190, 210),
			SelectedTabTextColor = Color3.fromRGB(0, 0, 0),

			ElementBackground = Color3.fromRGB(35, 60, 100), -- [✨ Fix Bug: Matching Base Color]
			ElementBackgroundHover = Color3.fromRGB(55, 90, 135), -- [✨ Fix Bug: Visible Hover Color]
			SecondaryElementBackground = Color3.fromRGB(25, 45, 80),
			ElementStroke = Color3.fromRGB(45, 80, 130),
			SecondaryElementStroke = Color3.fromRGB(35, 60, 100),

			SliderBackground = Color3.fromRGB(18, 18, 26),
			SliderProgress = Color3.fromRGB(0, 200, 255),
			SliderStroke = Color3.fromRGB(0, 160, 220),

			ToggleBackground = Color3.fromRGB(18, 18, 26),
			ToggleEnabled = Color3.fromRGB(0, 200, 255),
			ToggleDisabled = Color3.fromRGB(60, 60, 75),
			ToggleEnabledStroke = Color3.fromRGB(0, 230, 255),
			ToggleDisabledStroke = Color3.fromRGB(80, 80, 95),
			ToggleEnabledOuterStroke = Color3.fromRGB(0, 120, 180),
			ToggleDisabledOuterStroke = Color3.fromRGB(40, 40, 55),

			DropdownSelected = Color3.fromRGB(90, 140, 200), -- [✨ FIX BUG: Bright highlighted color]
			DropdownUnselected = Color3.fromRGB(35, 60, 100), -- [✨ FIX BUG: Normal background]
...
Rayfield.Enabled = true -- [⚡ TURBO BY ANTIGRAVITY]
			...
			for _, element in ipairs(tab:GetChildren()) do
				if element.ClassName == "Frame" then
					if element.Name ~= "SectionSpacing" and element.Name ~= "Placeholder" then
						...
						elseif element.Name == "SubTabsContainer" then
							-- Custom handling for SubTabs so it doesn't crash Rayfield's Tweening
...
function RayfieldLibrary:CreateWindow(Settings)
	if Rayfield:FindFirstChild('Loading') then
		if getgenv and not getgenv().rayfieldCached then
			...
			Rayfield.Loading.Visible = false -- [❌ DISABLED BY ANTIGRAVITY]
		end
	end
	...
	Main.Size = useMobileSizing and UDim2.new(0, 500, 0, 275) or UDim2.new(0, 500, 0, 475) -- [⚡ SNAP-SIZE BY ANTIGRAVITY]
	Topbar.Size = useMobileSizing and UDim2.new(0, 500, 0, 45) or UDim2.new(0, 500, 0, 45) -- [⚡ SNAP-SIZE BY ANTIGRAVITY]
	Main.Visible = true
	Main.BackgroundTransparency = 0 -- [✅ INSTANT BY ANTIGRAVITY]
	if Main:FindFirstChild('Notice') then Main.Notice.Visible = false end
	Main.Shadow.Image.ImageTransparency = 0.6 -- [✅ INSTANT BY ANTIGRAVITY]
	...
	Topbar.Visible = true -- [✅ ENABLED BY ANTIGRAVITY]
	Elements.Visible = true -- [✅ ENABLED BY ANTIGRAVITY]
	LoadingFrame.Visible = false -- [❌ DISABLED BY ANTIGRAVITY]
	...
	function Window:CreateTab(Name, Image, Ext)
		...
		-- [⚡ INSTANT TAB ACTIVATION BY ANTIGRAVITY]
		...
		-- SubTabs (Navigation)
		function Tab:CreateSubTabs(SubTabSettings)
			local SubTabValue = {}
			local Options = SubTabSettings.Options or {}
			
			local Container = Instance.new("Frame")
			Container.Name = "SubTabsContainer"
			...
			local function UpdateButtons(selected)
				for name, btn in pairs(Buttons) do
					if name == selected then
						TweenService:Create(btn, TweenInfo.new(0.3), {BackgroundColor3 = SelectedTheme.ElementBackgroundHover}):Play()
						TweenService:Create(btn.UIStroke, TweenInfo.new(0.3), {Transparency = 0, Color = SelectedTheme.TabStroke}):Play()
						TweenService:Create(btn.Title, TweenInfo.new(0.3), {TextColor3 = SelectedTheme.SelectedTabTextColor}):Play()
					else
						TweenService:Create(btn, TweenInfo.new(0.3), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
						TweenService:Create(btn.UIStroke, TweenInfo.new(0.3), {Transparency = 0.5, Color = SelectedTheme.ElementStroke}):Play()
						TweenService:Create(btn.Title, TweenInfo.new(0.3), {TextColor3 = SelectedTheme.TextColor}):Play()
					end
				end
			end
			...
			for i, optionName in ipairs(Options) do
				...
				Button.Title.Text = optionName
				Button.Size = UDim2.new(1/btnCount, -(5 * (btnCount - 1) / btnCount), 1, 0)
				Button.BackgroundColor3 = SelectedTheme.ElementBackground
				Button.BackgroundTransparency = 0
				Button.UIStroke.Transparency = 0.5
				Button.Title.TextTransparency = 0
				if Button:FindFirstChild("ElementIndicator") then Button.ElementIndicator.Visible = false end
				...
				Button.Interact.MouseButton1Click:Connect(function()
					if rayfieldDestroyed then return end
					if ActiveOption == optionName then return end
					ActiveOption = optionName
					UpdateButtons(ActiveOption)
					pcall(SubTabSettings.Callback, optionName)
				end)
			end
			...
			function SubTabValue:Set(NewOption)
				if table.find(Options, NewOption) then
					ActiveOption = NewOption
					UpdateButtons(ActiveOption)
					pcall(SubTabSettings.Callback, NewOption)
				end
			end
            
			function SubTabValue:Visible(bool)
		...
		function Tab:CreateButton(ButtonSettings)
			...
			Button.BackgroundColor3 = SelectedTheme.ElementBackground -- [✨ FIX HOVER BUG]
			Button.BackgroundTransparency = 0 -- [⚡ INSTANT]
		...
		function Tab:CreateSection(SectionName)
			...
			Section.Title.TextTransparency = 0.4 -- [⚡ INSTANT]

			function SectionValue:Set(NewSection)
				Section.Title.Text = NewSection
			end

			function SectionValue:Visible(bool)
				Section.Visible = bool
				if SectionSpace then SectionSpace.Visible = bool end
			end
		...
		function Tab:CreateDivider()
			...
			Divider.Divider.BackgroundTransparency = 0.85 -- [⚡ INSTANT]
		...
		function Tab:CreateLabel(LabelText : string, Icon: number, Color : Color3, IgnoreTheme : boolean)
			...
			Label.Icon.ImageTransparency = 0.2 -- [⚡ INSTANT]
		...
		function Tab:CreateParagraph(ParagraphSettings)
			...
			Paragraph.BackgroundTransparency = 0 -- [⚡ INSTANT]
		...
		function Tab:CreateInput(InputSettings)
			...
			Input.BackgroundColor3 = SelectedTheme.ElementBackground -- [✨ FIX HOVER BUG]
			Input.BackgroundTransparency = 0 -- [⚡ INSTANT]
		...
		function Tab:CreateDropdown(DropdownSettings)
			...
			Dropdown.BackgroundColor3 = SelectedTheme.ElementBackground -- [✨ FIX HOVER BUG]
			Dropdown.BackgroundTransparency = 0 -- [⚡ INSTANT]
		...
		function Tab:CreateKeybind(KeybindSettings)
			...
			Keybind.BackgroundColor3 = SelectedTheme.ElementBackground -- [✨ FIX HOVER BUG]
			Keybind.BackgroundTransparency = 0 -- [⚡ INSTANT]
		...
		function Tab:CreateToggle(ToggleSettings)
			...
			Toggle.BackgroundColor3 = SelectedTheme.ElementBackground -- [✨ FIX HOVER BUG]
			Toggle.BackgroundTransparency = 0 -- [⚡ INSTANT]
			Toggle.UIStroke.Transparency = 0
			Toggle.Title.TextTransparency = 0
			Toggle.Switch.BackgroundColor3 = SelectedTheme.ToggleBackground

			if SelectedTheme ~= RayfieldLibrary.Theme.Default then
				if Toggle.Switch:FindFirstChild("Shadow") then Toggle.Switch.Shadow.Visible = false end
			end	
		...
		function Tab:CreateSlider(SliderSettings)
			...
			Slider.BackgroundColor3 = SelectedTheme.ElementBackground -- [✨ FIX HOVER BUG]
			Slider.BackgroundTransparency = 0 -- [⚡ INSTANT]
			Slider.UIStroke.Transparency = 0
			Slider.Title.TextTransparency = 0

			if SelectedTheme ~= RayfieldLibrary.Theme.Default then
				if Slider.Main:FindFirstChild("Shadow") then Slider.Main.Shadow.Visible = false end
			end
	...
	-- [⚡ PHASE 2 NUKED BY ANTIGRAVITY — INSTANT ACTIVATION]
